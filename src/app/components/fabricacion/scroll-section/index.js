      ...
      <div className=" container bg-black" ref={containerRef}>
        ...
        <section className="panel flex flex-col items-center justify-evenly px-[var(--padding-x)] py-[var(--padding-y)]  ">
          <div className="flex w-full text-right justify-end">
            <p className="md:w-[700px]">
              ...
              nuestros clientes mediante una atención personalizada. Por ello,
              nos enfocamos en desarrollar productos certificados de alta
              calidad, efectivos e innovadores, que cumplen con los requisitos
              específicos de nuestros clientes y se construyen bajo rigurosos
              estándares y normativas de seguridad vigentes.
            </p>
          </div>
        ...
        <section className=" relative panel  flex flex-col  px-[var(--padding-x)] py-[var(--padding-y)]">
          <div className="flex-1 flex flex-col gap-4">
            ...
            <p>
              Destinada a contener y gestionar los efluentes generados durante
              las operaciones, con sistemas de control y tratamiento para
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <p>
              Equipadas con zaranda para separar eficientemente partículas
              sólidas de fluidos como lodos, garantizando que el fluido
              descargado esté libre de impurezas.
            </p>
          </div>
          <div className="flex-1 flex flex-col gap-4">
            ...
            <p>
              ...
              industria petrolera. Ideal para evaluar el rendimiento de equipos
        ...
        <section className=" panel flex flex-col  px-[var(--padding-x)] py-[var(--padding-y)] justify-evenly  ">
          <div className="flex flex-col gap-4">
            ...
            <p>
              Contenedores diseñados para el almacenamiento y transporte seguro
              de combustible diesel y otros derivados del petróleo, construidos
              con materiales resistentes y características específicas.
            </p>
          </div>
          <div className="flex flex-col gap-4">
            <div className="flex-1 flex  align-middle items-center ">
            ...
            <p>
              Vehículos de transporte y estructuras móviles que ofrecen
              soluciones flexibles para oficinas móviles, dormitorios o
        ...
        <section className=" panel flex flex-col  px-[var(--padding-x)] py-[var(--padding-y)] justify-evenly  ">
          <div className="flex flex-col gap-4">
            ...
            <p>
              ...
              en diferentes entornos industriales, ideales para instalaciones de
              procesamiento, perforación u otras operaciones petroleras y de
              gas.
            </p>
          </div>
          <div className="flex flex-col gap-4">
            ...
            <p>
              Sistemas de tuberías diseñados para transportar lodos, petróleo,
